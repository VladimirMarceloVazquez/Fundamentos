...
public class ArrayDemo {
 public static void main(String[] args) {
	...
	anArray[2] = 300; //Inicializa el tercer elemento
	anArray[3] = 400; //Inicializa el cuarto elemento
	anArray[4] = 500; //Inicializa el quinto elemento
	anArray[5] = 600; //Inicializa el sexto elemento
